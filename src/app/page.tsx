...
const techStack1 = [
  ...
  'PYTORCH', 'TENSORFLOW', 'SCIKIT-LEARN', 'HUGGING FACE', 'MODEL FINE-TUNING'
];

const techStack2 = [
  'NODE.JS', 'FASTAPI', 'EXPRESS', 'MICROSERVICES', 'REST APIS', 'REDIS', 
  'MONGODB', 'POSTGRESQL', 'POSTGIS', 'REACT', 'NEXT.JS', 'REACT NATIVE', 
  'TAILWIND CSS', 'VITE', 'DOCKER', 'AWS', 'GCP', 'CI/CD', 'VERCEL', 
  'FIREBASE', 'FULL-STACK AI ENGINEER'
];
