...
export default function SkillsSection() {
  ...
  const skills = [
    ...
    { name: "LangGraph / LangGraph.js", type: "ai", icon: "" },
    { name: "MCP Protocol", type: "ai", icon: "" },
    { name: "Neo4j (Graph DB)", type: "ai", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/neo4j.svg" },
    { name: "Qdrant Cloud", type: "ai", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/qdrant.svg" },
    ...
    { name: "Gemini 2.5 API", type: "ai", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/googlegemini.svg" },
    { name: "Ragas", type: "ai", icon: "" },
    { name: "DeepEval", type: "ai", icon: "" },
    { name: "TruLens", type: "ai", icon: "" },
    ...
    { name: "Debezium (CDC)", type: "backend", icon: "" },
    { name: "Apache Kafka", type: "backend", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/apachekafka.svg" },
    ...
    { name: "Flask API", type: "backend", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flask/flask-original.svg" },
    ...
    { name: "React 19", type: "framework", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" },
    ...
    { name: "Recharts", type: "framework", icon: "" },
    { name: "Plotly", type: "framework", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/plotly.svg" },
    ...
    { name: "Playwright", type: "devops", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/playwright.svg" },
    ...
    { name: "Netlify", type: "devops", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/netlify.svg" },
